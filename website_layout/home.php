...
<body>
    ...
    <div class="additional-box">
        <div class="button-group">
            ...
            <button onclick = "window.location.href='servicemapindex.php';" class="btn btn-secondary">Service station locator</button>
            <button onclick = "window.location.href='esmapindex.php';" class="btn btn-secondary">Charging dock locator</button>
        </div>
    </div>
</body>
</html>